...
#    | Sato | 11 | TC AI11 03 Invalid: More than 6 digits | 7777777 | .\Labels\BarcodeAI11.xml   | TC_AI11_03.txt | G0L1EPrinter.SATO_Printerdata.txt |
...
#    | Sato | 250 | TC AI250 02 Valid: Empty |  | .\Labels\BarcodeAI250.xml   |